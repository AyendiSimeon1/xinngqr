    ...
    <aside class="preview" aria-label="Public page preview">
      <header class="preview-header">
        <div class="url-pill">
          ...
          <button class="label-icon"><a class="icon-btn" href="<?= e($displayUrl) ?>" target="_blank" rel="noopener" aria-label="Open public page"><i class="fa-solid fa-mouse-pointer"></i></a></button>
