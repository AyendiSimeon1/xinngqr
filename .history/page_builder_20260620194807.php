      ...
      <div class="builder-panel">
        <section class="builder-tab active" id="tab-build">
          ...
          <div class="block-type-menu" id="block-type-menu" hidden>
            <button data-type="link" type="button">Link block</button>
            <button data-type="image" type="button">Image block</button>
            <button data-type="text" type="button">Text block</button>
            <button data-type="social" type="button">Social block</button>
            <button data-type="qr" type="button">QR / Short link block</button>
          </div>
        ...
        <section class="builder-tab" id="tab-track"><div class="design-card"><h2>Analytics coming soon.</h2><p class="muted-row">Views, clicks, and engagement reports will appear here later.</p></div></section>
      </div>
    </section>
