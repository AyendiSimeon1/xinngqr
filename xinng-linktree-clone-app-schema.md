# xin.ng — QR Link Manager / Linktree Clone App

## 1. App Overview

**xin.ng** is a QR-powered Linktree-style platform that allows users to create a personal or business landing page, create short memorable links, and generate trackable QR codes.
...
This makes **xin.ng** useful for events, businesses, personal brands, sales teams, creators, restaurants, consultants, churches, schools, real estate agents, and anyone who needs one shareable link or QR code that can be updated later.
...
The domain **xin.ng** is short, memorable, and Nigerian by extension. It feels like “Xing,” “sync,” and “sign-in,” which fits a QR/link manager well. The `.ng` extension gives local trust and startup credibility, especially for Nigerian SMEs, events, creators, and field sales teams.

Potential brand risk: some users may type `xing.ng` by mistake, so the brand should consistently pronounce the product as **Xing** while writing it as **xin.ng**.

---

## 3. What the App Does

**xin.ng** allows users to:
...
The landing page explains **xin.ng** and encourages users to sign up.
...
- Social icons
- Active links
- Branding or “powered by xin.ng” text, depending on user plan
...
Record QR scan
↓
Redirect visitor to https://xin.ng/u/micony
```

This allows **xin.ng** to track QR scans separately from normal page views.
...
### 5.11 Subscription and Monetization
...
```text
https://xin.ng/register
https://xin.ng/login
https://xin.ng/dashboard
https://xin.ng/u/micony
https://xin.ng/qr/micony
```

Future short public URL format:
...
The schema below is designed for a full **xin.ng** Linktree-style clone.
...
This gives **xin.ng** enough structure for:
...
16. `xin.ng` should be used as the canonical domain in public links, QR codes, and dashboard previews.
17. If possible, buy or redirect typo domains like `xing.ng` to reduce brand leakage.
...
**xin.ng** is a QR-powered Linktree clone.
